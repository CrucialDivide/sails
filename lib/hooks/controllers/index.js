				...
				_.each(sails.controllers, function (controller, controllerId) {
					...
					_.each(controllerActions, function (actionId) {
						...
						if (actionId === 'index') {
							...
							sails.emit('hook:controllers:bound:action', actionId, controllerId, blueprintsPrefix, indexRoute);
						}
						...
						sails.emit('hook:controllers:bound:action', actionId, controllerId, blueprintsPrefix, appliedRoute);
					});
				});
			}
